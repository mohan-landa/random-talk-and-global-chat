...
class RecyclerAdapterWordList$4 implements OnClickListener {
   // $FF: synthetic field
   final com.moganstar.randomtalk.grammar.adapter.RecyclerAdapterWordList this$0;
   // $FF: synthetic field
   final com.moganstar.randomtalk.grammar.adapter.RecyclerAdapterWordList.MyViewHolder val$holder;
   // $FF: synthetic field
   final int val$position;

   RecyclerAdapterWordList$4(com.moganstar.randomtalk.grammar.adapter.RecyclerAdapterWordList var1, com.moganstar.randomtalk.grammar.adapter.RecyclerAdapterWordList.MyViewHolder var2, int var3) {
      this.this$0 = var1;
   ...
   public void onClick(View var1) {
      ...
      var9.setOnClickListener(new com.moganstar.randomtalk.grammar.adapter.RecyclerAdapterWordList$4$2(this, var3));
      var10.setOnClickListener(new com.moganstar.randomtalk.grammar.adapter.RecyclerAdapterWordList$4$3(this, var3));
