...
class RecyclerAdapterWordList$4$1 implements OnClickListener {
   ...
   RecyclerAdapterWordList$4$1(com.moganstar.randomtalk.grammar.adapter.RecyclerAdapterWordList$4 var1, Dialog var2) {
      this.this$1 = var1;
   ...
   public void onClick(View var1) {
      ...
      if (var3) {
         this.this$1.this$0.myDictionaryInfo.setLevelColor(com.moganstar.randomtalk.grammar.adapter.RecyclerAdapterWordList.access$100(this.this$1.this$0).getLevel_number(), "green");
      } else {
